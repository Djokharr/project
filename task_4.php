...
<?php $persons = [
        ...
        [
          ...
          'job' => 'Lead Author',
          'mail' => '@myplaneticket',
 //         'link mail' => 'https://twitter.com/@myplaneticket',
          'contact' => 'myorange'
        ],
    [
        'name' => 'Jos K.',
                        ...
                        <div class="panel-content">
                           <div class="d-flex flex-wrap demo demo-h-spacing mt-3 mb-3">
                            ...
                            <div class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                <img src="<?php echo $persons['photo'];?>" alt="Sunny A." class="img-thumbnail img-responsive rounded-circle" style="width:5rem; height: 5rem;">
                                <div class="ml-2 mr-3">
                                    <h5 class="m-0">
                                        <?php echo $persons['name']; echo ' ' . $persons['profession'];?>
                                        <small class="m-0 fw-300">
                                            <?php echo $persons['job'];?>
                                        </small>
                                    </h5>


                                    <a href="https://twitter.com/<?php echo $persons['mail'];?>" class="text-info fs-sm" target="_blank"><?php echo $persons['mail'];?></a>

                                    -
                                    <a href="https://wrapbootstrap.com/user/<?php echo $persons['contact'];?>" class="text-info fs-sm" target="_blank" title="Contact Sunny"><i class="fal fa-envelope"></i></a>
                                </div>
                            </div>
                               <?php endforeach;?>
<!--                            <div class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">-->
