...
<?php $persons = [
    ...
    [
        'name' => 'Dr. John Oliver',
        'job' => ' john.oliver@smartadminwebapp.com',
...
?>
                <div class="col-xl-4">
                    <div id="c_<?php echo $person['id']?>" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?php echo $person['tag']?>">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-<?php echo $person['status']?> mr-1">
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                <a href="tel:<?php echo $person['number']?>" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mobile-alt text-muted mr-2"></i> <?php echo $person['number']?></a>
                                <a href="mailto:<?php echo $person['mail']?>" class="mt-1 d-block fs-sm fw-400 text-dark">
