                        ...
                        <div class="panel-content">
                            <div class="panel-content">
                                <div class="bg-warning-100 border border-warning rounded">
                                    ...
                                    <?php $items = ['Reports' => 'reports file','Analytics' => 'analytics graphs','Export' => 'export download','Storage' => 'storage'];
                                         // $tags =  ['reports file','analytics graphs','export download','storage'];
                                    ?>
                                    <ul id="js-list-msg" class="list-group px-2 pb-2 js-list-filter">
                                        <?php foreach ($items as $key => $item):;?>
                                        <li class="list-group-item">
                                            <span data-filter-tags="<?echo $item?>"><?echo $key?></span>
                                        </li>
                                        <?php endforeach; ?>
                                    </ul>
