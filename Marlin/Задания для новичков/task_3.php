                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <div class="d-flex mt-2">
                                <?php echo $case['name'];?>
                                <span class="d-inline-block ml-auto"><?php echo $case['score']; ?></span>
                            </div>
                            <div class="progress progress-sm mb-3">
                                <div class="<?php echo $case['color']; ?>" role="progressbar" style="width: <?php echo $case['width']; ?>%;" aria-valuenow="<?php echo $case['width']; ?>" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <?php endforeach ?>
<!--                            <div class="d-flex">-->
<!--                                Transfered-->
